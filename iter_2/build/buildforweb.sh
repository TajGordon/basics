...
#--------------------------------#
emcc -o index.html ../src/main.cpp -Os -Wall /Users/tajgordon/Developer/raylib/src/libraylib.a -I. -I/Users/tajgordon/Developer/raylib/src/raylib.h -L. -L/Users/tajgordon/Developer/raylib/src/librarylib.a -s USE_GLFW=3 -s ASYNCIFY -DPLATFORM_WEB --preload-file ../assets -s FORCE_FILESYSTEM=1 -s TOTAL_MEMORY=67108864 -s 'EXPORTED_FUNCTIONS=["_free","_malloc","_main"]' # --shell-file /Users/tajgordon/Developer/raylib/src/minshell.html
